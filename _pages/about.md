...
{% include figure.liquid loading="eager" path="/assets/img/2025_robocup.gif" class="img-fluid rounded z-depth-1" alt="Competition placeholder image" %}
...
{% include figure.liquid loading="eager" path="/assets/img/2024_robocup.gif" class="img-fluid rounded z-depth-1" alt="Competition placeholder image" %}
...
{% include figure.liquid loading="eager" path="/assets/img/2023_robocup.gif" class="img-fluid rounded z-depth-1" alt="Competition placeholder image" %}
...
{% include figure.liquid loading="eager" path="/assets/img/2024_zeus.jpg" class="img-fluid rounded z-depth-1" alt="Competition placeholder image" %}
...
{% include figure.liquid loading="eager" path="/assets/img/2023_mule.gif" class="img-fluid rounded z-depth-1" alt="Competition placeholder image" %}
...
{% include figure.liquid loading="eager" path="/assets/img/2023_baemin_robot.jpg" class="img-fluid rounded z-depth-1" alt="Competition placeholder image" %}
- Developed a low-level motor driver interface for real-robot delivery platforms.

<!-- ### Baemin Autonomous Delivery Challenge (Simulation) 2023 - First Place (Ministerial Award, MOTIE)
{% include figure.liquid loading="eager" path="/assets/img/7.jpg" class="img-fluid rounded z-depth-1" alt="Competition placeholder image" %}
- Contributed to task setup and overall simulation performance optimization. -->

## Publications

### Dynamic Scoop-and-Flick Manipulation for Rapid Non-Prehensile High-Arc Object Transfer
{% include figure.liquid loading="eager" path="/assets/img/throw_in_bucket.jpg" class="img-fluid rounded z-depth-1" alt="Publication placeholder image" %}
- **ICRA 2026**
- G. Ahn*, J. Lee*, S. Oh, M. Shin, S.-J. Yi, and J. Seo

### ANUBIS: A Compact, Low-Cost, Compliant Humanoid Mobile Manipulation Robot
{% include figure.liquid loading="eager" path="/assets/img/anubis.jpg" class="img-fluid rounded z-depth-1" alt="Publication placeholder image" %}
...
{% include figure.liquid loading="eager" path="/assets/img/rucio.jpg" class="img-fluid rounded z-depth-1" alt="Publication placeholder image" %}
...
{% include figure.liquid loading="eager" path="/assets/img/JF2_JF2mini.jpg" class="img-fluid rounded z-depth-1" alt="Publication placeholder image" %}
- **Sensors, 24(20), 6704**
...
{% include figure.liquid loading="eager" path="/assets/img/tommoro.jpg" class="img-fluid rounded z-depth-1" alt="Internship placeholder image" %}
